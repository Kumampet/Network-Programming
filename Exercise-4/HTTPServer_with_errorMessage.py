...
while True:
	...
	try:
		...
		connectionSocket.close()
        	...
        	errorMessage = '<html><head></head><body><h1>404 Not Found</h1><p>Server Address: '+ str(serverAddr) + '<br>Server Port: ' + str(serverPort) + '<br>Client Address, Port: ' + str(clientAddress) + '</p></body></html>\r\n'
